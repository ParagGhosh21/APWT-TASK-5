                ...
                ">
                    <form action="{{route('addUser')}}" method="post">
                        ...
                        <table class="mb-4">
                            <tr>
                                ...
                                <td> 
                                    ...
                                    <div class="text-center text-white" style="width: 100%; padding: 10px 105px; margin-left: 20px; border-radius: 10px; background-color: white">
                        ...
                        <div class="d-flex">
                            ...
                            <div class="mx-3">
                                <input type="submit" value="Add" class="btn btn-dark btn-sm mt-3 px-4">
                            </div>
                        </div>
                    </form>
                </div>
