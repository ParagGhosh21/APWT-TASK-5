                    ...
                    ">
                        ...
                        <form action="{{route('updateUser')}}" method="post">
                            ...
                            <table class="mb-4">
                                <tr>
                                    <td>
                                        <h4 class="fw-bold mt-5">Update {{ $users->name }}'s Information</h4>
                                    </td>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-3 py-2" style="width:400px;"><input type="text" value={{ $users->name }}
                                ...
                                <tr hidden>
                                    ...
                                    <td class="pr-3 py-2"><select type="input" value={{ $users->role }} name="role"
                                            class="form-control">
                                ...
                                <tr hidden>
                                    ...
                                    <td class="pr-3 py-2"><input value={{ $users->email }} type="text" name="email"
                                            class="form-control">
                                    </td>
                                    <td>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <span class="text-secondary"> {{ session('database-error') }}</span>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="pr-3 py-2"><input style="width:400px;" value={{ $users->address }} type="text" name="address"
                                ...
                                <tr>
                                    ...
                                    <td class="pr-3 py-2"><input value={{ $users->phone }} type="text" name="phone"
                                            class="form-control">
                                    </td>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    ...
                                    <td class="pr-3 py-2"><input value={{ $users->password }} type="password"
